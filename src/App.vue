...
<template>
  <div class="min-h-screen bg-gradient-to-br from-pink-50 via-rose-50 to-red-50">
    ...
    <!-- Bottom Navigation -->
    <nav class="fixed bottom-0 left-0 right-0 bg-white/90 backdrop-blur-md border-t border-pink-200 shadow-lg">
      <div class="flex justify-around items-center py-2">
        <RouterLink 
          to="/day" 
          class="flex flex-col items-center p-3 rounded-lg transition-all duration-150 transform hover:scale-110"
        ...
        >
          ...
          <span class="text-xs font-medium">Día</span>
        </RouterLink>
        ...
        >
          ...
          <span class="text-xs font-medium">Mes</span>
        </RouterLink>
      </div>
    </nav>
    ...
    >
      <button
        ...
        class="fixed bottom-24 right-4 bg-gradient-to-r from-pink-500 to-rose-500 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-110 hover:rotate-12 animate-bounce"
      >
        <Plus class="w-6 h-6" />
      </button>
    </Transition>
